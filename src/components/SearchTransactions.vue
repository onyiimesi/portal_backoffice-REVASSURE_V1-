                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="page-title-box d-flex align-items-center justify-content-between">
                              <h4 class="mb-0">Transaction Search <br> <span style="font-size: 14px;font-weight: 500;">{{customerDetails.organizationCode}} //  {{customerDetails.subOrganisationCode}} //</span> <span style="font-size: 14px;font-weight: 500;">{{customerDetails.lastName}} {{customerDetails.firstName}} // {{this.role}}</span></h4>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control mb-4">
                                                    <option value="">Agency for Agriculture</option>
                                                    <option value="">Agency for Procurement</option>
                                                    <option value="">Ajeromi General Hospital</option>
                                                    <option value="">Agency for Works</option>
                                                </select>
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label">Select Sub-Organization</label>
